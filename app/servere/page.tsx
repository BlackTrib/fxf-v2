...
const servers = [
  {
    ...
    desc: 'Servere VPS cloud pentru proiecte care necesită resurse dedicate și control complet. Root access, alegere sistem de operare (Linux/Windows) și scalare flexibilă după nevoi. Ideal pentru dezvoltatori, aplicații și proiecte în creștere.',
    features: [
  ...
  },
  {
    ...
    desc: 'Servere fizice dedicate pentru cele mai exigente proiecte. Putere de procesare maximă, securitate totală și control complet asupra hardware-ului. Ideal pentru baze de date mari, aplicații enterprise și trafic intens.',
    features: [
      'Hardware fizic dedicat',
