...
import { ShoppingBag, ArrowRight, HardDrive, Shield, Clock, Headphones, Zap, Globe, Database, Cpu, Lock, RefreshCw, Server, CreditCard } from 'lucide-react'

export const metadata: Metadata = {
  title: 'Găzduire OpenCart România | Hosting E-Commerce de la 55 lei | FXF',
  description: 'Găzduire OpenCart optimizată pe servere SSD NVMe. Auto-instalare, SSL gratuit, backup zilnic. Perfect pentru magazine online OpenCart!',
  keywords: ['gazduire opencart', 'hosting opencart', 'opencart romania', 'hosting magazin online', 'opencart hosting'],
  openGraph: {
    title: 'Găzduire OpenCart România | Hosting E-Commerce de la 55 lei | FXF',
    description: 'Găzduire OpenCart optimizată cu auto-instalare, SSL gratuit și suport specializat.',
    url: 'https://fxfweb.ro/servicii/gazduire-opencart',
  },
  alternates: { canonical: 'https://fxfweb.ro/servicii/gazduire-opencart' },
}
...
const benefits = [
  { icon: Zap, title: 'Auto-Instalare OpenCart', desc: 'Instalare OpenCart cu un click direct din cPanel.' },
  ...
  { icon: Globe, title: 'Multi-Store Support', desc: 'Găzduiește mai multe magazine pe același cont.' },
  ...
  { icon: Headphones, title: 'Suport E-Commerce', desc: 'Echipă specializată în magazine online OpenCart.' },
]
      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
            <div className="max-w-3xl">
              ...
              <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6 text-balance">
                Găzduire OpenCart
                <span className="block text-2xl sm:text-3xl lg:text-4xl mt-2 text-white/70">Magazine online rapide și sigure</span>
              </h1>
              <p className="text-white/70 text-lg sm:text-xl leading-relaxed mb-8">
                Găzduire OpenCart optimizată cu resurse dedicate pentru magazine cu mii de produse. 
        ...
        <section className="py-12 bg-primary">
          <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
            ...
            <p className="text-white/60 text-lg mb-8">Migrăm gratuit magazinul tău OpenCart fără pierdere de date sau downtime.</p>
