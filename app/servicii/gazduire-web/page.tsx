...
export const metadata: Metadata = {
  ...
  description: 'Găzduire web pe servere SSD NVMe în România. 4 pachete de la 55 lei/6 luni cu cPanel, SSL gratuit, backup zilnic și suport 24/7. Uptime 99.9% garantat!',
  keywords: ['gazduire web', 'hosting romania', 'gazduire ssd', 'web hosting', 'gazduire nvme', 'hosting ieftin', 'cpanel hosting'],
  openGraph: {
    title: 'Găzduire Web SSD România | Hosting de la 55 lei | FXF Web Hosting',
  ...
  alternates: { canonical: 'https://fxfweb.ro/servicii/gazduire-web' },
}
...
const packages = [
  ...
  },
  {
    ...
    price: '207',
    period: '6 luni',
    desc: 'Perfect pentru site-uri de afaceri și proiecte medii.',
    popular: true,
    features: [
...
const benefits = [
  ...
  { icon: Server, title: 'cPanel Inclus', desc: 'Panou de control intuitiv pentru gestionarea ușoară a hosting-ului.' },
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
            <div className="max-w-3xl">
              ...
              <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6 text-balance">
                Găzduire Web SSD
                <span className="block text-2xl sm:text-3xl lg:text-4xl mt-2 text-white/70">Servere NVMe rapide in Germania</span>
              </h1>
